      ...
      <section className="primary-grid">
        ...
        <article className="panel audit" id="decisions">
          ...
          <div className="audit-grid">
            ...
            <div><small>Daily Drawdown</small><strong className={auditDrawdown == null || auditDrawdownLimit == null ? "" : auditDrawdown >= auditDrawdownLimit ? "bad" : "good"}>{auditDrawdown == null ? "--" : `${auditDrawdown.toFixed(2)}%`}</strong><em>{auditDrawdownLimit == null ? "limite desconhecido" : `limit ${auditDrawdownLimit.toFixed(2)}%`}</em></div>
